...
public class LogitechGSDK
{
    ...
    internal static float LogiGetSteeringWheelValue(int v)
    {
    ...
    internal static float LogiGetPedalValue(int v)
    {
        throw new NotImplementedException();
    }
    ...
    internal static void LogiGetControllerProperties(int v, ref LogiControllerPropertiesData properties)
    {
        throw new NotImplementedException();
    }
    ...
    internal static float LogiControllerGetAxisValue(int v, int footBrakeAxis)
    {
        throw new NotImplementedException();
    }
    ...
    internal class LogiControllerState
    {
        internal float acceleratorPedal;
        internal float brakePedal;
    }
}
